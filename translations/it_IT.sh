...
export info_uninstall_detected_elementary="Individuato contratto di pantheon file manager (elementary):"
export info_uninstall_detected_thunar="Individuata azione di thunar file manager:"
export info_uninstall_deleting_thunar="eliminazione azione di thunar con script awk (utils.sh:deleteThunarAction) . . ."
...
export info_uninstall_err_elementary="errore nella cancellazione contratto elementary"
export info_uninstall_err_thunar="errore nella cancellazione azione thunar"
